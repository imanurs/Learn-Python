...
img = Image.open(r'D:\TECH\VS Code Projects\(Learn) Python\Learning Python\2_variables_build-in-functions\build-in-functions.jpg')
img.show()
...
is_married = True                                                #boolean. valuenya True atau False. 
                                                                 #ini buat ngeevaluasi value. misal value 10 < 5, ntar hasilnya False. buat ngevalidasi value gt sih
                                                                 #kalo misal variable ini valuenya true, brt belum ada valuenya
